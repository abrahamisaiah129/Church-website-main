...
<body>
    ...
    <div class="container py-5 my-5">
        <div class="text-center mb-5">
            <h2 class="fw-bold text-warning mb-2">Explore Our Gallery</h2>
            <p class="lead text-secondary">From monthly fellowships to special annual celebrations, find a memory to be a part of.</p>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 mb-5">
            <div class="position-relative flex-grow-1 w-100 w-md-auto">
                <input type="text" id="searchInput" placeholder="Search events..." class="form-control rounded-pill ps-4 pe-5" onkeyup="filterGallery()">
            ...
            <select id="eventTypeFilter" class="form-select w-100 w-md-auto rounded-pill" onchange="filterGallery()">
                <option value="">Pastor's Gallery</option>
                <option value="">Church's Gallery</option>
            </select>
        </div>
